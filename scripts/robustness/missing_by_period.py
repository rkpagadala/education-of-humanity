...
Method:
  1. For each five-year observation point in 1975-2015, count:
       - countries with parental education at T-28
  ...
  2. Re-estimate the headline parental-education coefficient
     (one-way country FE; child lower-sec on parental at T-28,
...
def main():
    ...
    # Parent education is read at ny = y - LAG_GENERATION (28), off the 5-year grid;
    # interpolate to annual so the lagged lookup resolves (on-grid at the old 25).
