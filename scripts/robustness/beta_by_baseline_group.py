...
Life-history label (§the-generational-lag):
  Predictor: 20-24 cohort completion at T (post-1975). Outcomes at
  T+25. Stratified by 1975 lower-sec baseline (low / mid / high).
  Cross-generation step. Use: amplification-at-low-baselines test
  (Prediction 6). β_g > 1 at low baselines, approaches 0 at high.
...
from _shared import (PROC, REGIONS, write_checkin, LAG_GENERATION,
...
def main():
    ...
    # Build panel: child(t) ~ parent(t - LAG_GENERATION) for t in 1975..2015
    rows = []
