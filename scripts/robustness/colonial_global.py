...
Life-history label (§the-generational-lag):
  Predictors: WCDE 20-24 cohort completion vs AJR institutional
  quality scores. Outcomes: TFR/LE/U5MR/childEdu at T+25 (cross-
  generation step). Use: identification — head-to-head on the
  global panel without AJR's selected colony sample restriction.
