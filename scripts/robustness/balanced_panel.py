...
#
# Produces:
#   Re-estimates the Table 1 Column 1 headline (child_t ~ parent_{t-28},
...
def load_panel():
    ...
    # The parental lag (28) is off the 5-year WCDE grid; interpolate to annual so
    # the parent lookup at child_year - 28 resolves (child cohorts stay on grid).
