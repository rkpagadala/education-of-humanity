...
#   Predictor and outcome are BOTH in the same country-year, but
#   measure different age cohorts: young (20-24) edu vs older (40-64)
#   edu. Implicitly identifies the parent → child chain WITHIN year
#   without needing a forward lag. Use: identification independent
#   of the T+28 forward-lag design.
#
# Produces:
#   Independent test of the intergenerational-transmission mechanism that
#   does NOT rely on the 28-year forward lag. Uses WCDE v3 population-share
...
#     parent = age 45-49  (28 years older — one generation)
#
#   Regression:
...
SCENARIO = 2
# Child and parent age groups (parent is 28 years older — one generation).
CHILD_AGE = "20--24"
PARENT_AGE = "45--49"
# Active-expansion subsample: parent-cohort completion below this percentage.
...
def main():
    ...
    write_checkin("cross_cohort_within_year.json", {
        "notes": (
            "Within-year cross-cohort test of home-niche transmission. "
            ...
            "rely on the 28-year forward lag: parent and child are observed "
