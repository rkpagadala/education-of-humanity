...
Education-band selection (not entry-cohort filtering), country FE,
lower-secondary completion, T=1960-1990. U5MR/U1MR read at the
childrearing-window lag (LAG_CHILDREARING=12). Clustered SEs.
"""
...
from residualization._shared import (
    ...
    write_checkin, LAG_GENERATION, LAG_CHILDREARING,
)

T_YEARS = list(range(1960, 1995, 5))
LAG = LAG_CHILDREARING  # U5MR childrearing window (was LAG_GENERATION=28)
COL_NAME = "lower_sec"
