...
from _shared import write_checkin, load_education, LAG_GENERATION
...
def v(df_w, country, year):
    """Look up a value from wide-format DataFrame, linearly interpolating to
    annual over the 5-year WCDE grid (LAG_GENERATION=28 is off the grid)."""
