# =============================================================================
# PAPER ANCHOR — Chapter 9 §Education vs GDP at Population Scale
#   Question: does education's lead over GDP hold across all baselines of
#             the parental-education expansion?
#   Produces: Table~\ref{tab:cutoff} (paper line ~3151) — Edu β / R² vs GDP β / R²
#             at parental-education cutoffs from <10% through Full.
#   Checkin:  checkin/education_vs_gdp_by_cutoff.json
# =============================================================================
# Inputs:
...
from _shared import (PROC, DATA, REGIONS, NAME_MAP, write_checkin, LAG_GENERATION,
...
for c in low_w.index:
    ...
    for child_yr in CHILD_COHORTS:
        parent_yr = child_yr - LAG_GENERATION
