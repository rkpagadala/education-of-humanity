...
4. Run country fixed-effects regression:
   - education(T) → life expectancy(T+28)
   - log GDP(T) → life expectancy(T+28)
...
panel = build_panel(edu_annual, le_raw, gdp_raw, T_YEARS, LAG, "le_tp28")
...
print("\n" + "=" * 90)
print("Entry-Cohort Analysis: Education(T) vs GDP(T) → Life Expectancy(T+28)")
print("Country fixed effects | T = 1960-1990 (5yr) | Lag = 28 years")
...
for threshold in range(10, 91):
    ...
    r2_e, n_e, c_e = fe_r2("edu_t", "le_tp28", sub)
...
checkin = {
    "method": (
        ...
        "T = 1960/1965/.../1990, outcome = LE(T+28). "
