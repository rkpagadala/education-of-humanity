...
def main():
    ...
    # education to annual so lagged lookups resolve (on-grid at the old 25). Keep
    ...
    # Summary statistics describe the underlying data universe (185-country panel,
    # 1975-2015). The regression sample (148 countries, expansion window [10, 90])
    # is defined separately in panel_expansion_fe.py.
    ...
    # "Edu + GDP" panel uses contemporaneous GDP (matches panel_expansion_fe Model 2).
