...
Defaults (changeable at top of script):
  ...
  BANGLADESH_PACE_PP  = 30      # +30pp over one generation
  BASELINE_YEAR       = 2015
  SCENARIO_YEARS      = 28      # one generation (LAG_GENERATION)
...
from _shared import (  # noqa: E402
    ...
    interpolate_to_annual, write_checkin, LAG_GENERATION,
)
...
BASELINE_YEAR = 2015
SCENARIO_YEARS = LAG_GENERATION   # one generation
