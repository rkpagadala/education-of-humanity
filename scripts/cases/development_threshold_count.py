...
from _shared import DATA, REPO_ROOT, REGIONS, WB_TO_WCDE, write_checkin
...
# WB (lowercase) → WCDE (lowercase) name map: imported from _shared so paper and
# outreach share one source of truth (was a local duplicate of the same dict).
