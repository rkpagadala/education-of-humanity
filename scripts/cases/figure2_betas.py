...
Verify Figure 2 country-specific sliding-window betas. The paper cites:
...
from _shared import PROC, write_checkin, LAG_GENERATION, interpolate_wide_to_annual

# ── Parameters (same as figures/beta_vs_baseline.py) ────────────────────────────
WINDOW_SIZE = LAG_GENERATION    # one generation (≈28yr)
STEP = 10
LAG = LAG_GENERATION
MIN_OBS = 3
...
# Parent lookups are at cy - LAG (28), off the 5-year cohort grid; interpolate
# to annual so lagged lookups resolve (these were on-grid at the old 25).
