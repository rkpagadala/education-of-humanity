...
Life-history label (§the-generational-lag):
  Predictor: 20-24 cohort completion at year 2010-L. At L=0 this is
  today's young adults; at L=25 the parent generation; at L=50 the
  grandparent generation; at L=60 the great-grandparent generation.
  Outcome: HLO country-mean centered on 2010 (test scores of the
  current school-age cohort).
  Generational relation: one-to-many-generation cognitive stock test.
  This is the multi-generation persistence test (Prediction 2).
  Use: empirical fit (which generational lag peaks). Primary peaks at
  L=25 (parent generation); lower-sec peaks at L=10.
...
If peak at L ≈ 25, it's the parent-generation home niche. If peak at
L ≈ 50, it's the grandparent home niche. If the curve is flat or broad, HLO reflects
...
from _shared import DATA, PROC, REPO_ROOT, REGIONS, write_checkin, FOR_WEB, PAPER_FIGS, WEB_FIGS
...
def main():
    ...
    # Shade home-niche generation windows
